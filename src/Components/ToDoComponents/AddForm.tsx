              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  {isTaskMode
                    ...
                    : "Organize your tasks with folders"}
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-5 relative z-10">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                disabled={
                  isTaskMode ? !addingTask.text.trim() : !newFolderName.trim()
                }
                className={`
                  flex-1 relative overflow-hidden rounded-xl px-6 py-3 font-medium text-white 
                  transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:cursor-pointer
                  ${
                    isTaskMode
