    ...
    <div className="sticky bottom-4 z-50 mx-4 mt-6">
      ...
      <div
        className="
          ...
          rounded-2xl shadow-2xl p-3 overflow-hidden w-80
      ...
      >
        ...
        {/* Bottom accent glow */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1/2 h-px bg-gradient-to-r from-transparent via-blue-400 to-transparent opacity-20" />
      </div>
